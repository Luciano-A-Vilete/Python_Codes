...
def main():
    # Call the circleArea function to compute
    ...
    print(f" cone is {ex_radius} and the height is {ex_height}, then the")
    ...
    # Call the coneVolume function to compute the volume
